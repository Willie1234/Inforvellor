...
public class LoadReportSummaryFieldUtil
{
	...
	public static <T>String fmtLoadDataHtml(String country, String reportType, Map resultFieldMap) 
	{
		...
		String [] oldFieldname = resultFieldMap.get(country+"_"+reportType+DataSearchConstantUtil.FIELDNAME).toString().split(",");
		...
		{
			if(!str.contains("比率")&&!str.contains("报表分析"))
			{
				fieldname.add(str);
			}
		}
