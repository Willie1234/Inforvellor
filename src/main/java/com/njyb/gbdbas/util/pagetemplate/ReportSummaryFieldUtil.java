...
//				paramList.add("'"+DataSearchConstantUtil.QS+"'");
			...
			String [] fieldname = resultFieldMap.get(country+"_"+cpTradeArray[i]+DataSearchConstantUtil.FIELDNAME).toString().split(",");
	...
	public static <T>String fmtCpCountryHtml(String country,Map reportFieldMap,Map resultFieldMap) 
	{
		...
		for(int i=0;i<cpCountryArray.length;i++)
		{
			...
			String [] fieldname = resultFieldMap.get(country+"_"+cpCountryArray[i]+DataSearchConstantUtil.FIELDNAME).toString().split(",");
	...
	public static <T>String fmtCpPortHtml(String country,Map reportFieldMap,Map resultFieldMap) 
	{
		...
		for(int i=0;i<cpPortArray.length;i++)
		{
			...
			String [] fieldname = resultFieldMap.get(country+"_"+cpPortArray[i]+DataSearchConstantUtil.FIELDNAME).toString().split(",");
