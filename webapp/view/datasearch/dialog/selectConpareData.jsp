		...
		<div class="" style="width: 380px; height: 350px;">
				<div class="">
					...
					<div id="customerbuttonFlexBr" style="padding-top: 240px;padding-left: 90px">
						<a class="confirmOrcancel_cls" title="确定" onclick="saveCompareData();">确定</a>&nbsp;&nbsp;&nbsp;
						<a class="confirmOrcancel_cls" title="取消" onclick="javascript:art.dialog({id:'selectCompareDataDialog'}).close();">取消</a>
					</div>
			</div>
		</div>
	</div>	  
