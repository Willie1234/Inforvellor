...
<body>
   <div class="mainDiv">
     <!-- 订单详情 -->
      <div>
         <div class='myT'><span> 订单信息</span></div>
          <div class="showInfo">
            <table cellspacing="5px;">
              <tr><td><span class='tag' >订单号：</span></td><td><input readonly="readonly" class='showText' type='text' id='orderNo'></td></tr>
              <tr><td><span class='tag' >商品名称：</span></td><td><input readonly="readonly"  class='showText' type='text' id='orderName'></td></tr>
              <tr><td><span class='tag' >收货人：</span></td><td><input readonly="readonly"  class='showText' type='text' id='consignee'></td></tr>
              <tr><td><span class='tag' >所在地：</span></td>
                  <td>
      ...
      <!-- 订单明细 -->
      <div>
         <div class='myT'><span>订单明细</span></div>
           <div class="showInfo">
             <table id='detTable'>
             </table>
           </div>
      ...
      <div>
	         <div id='noPay' style="width:300px;margin-left: 600px;padding-left: 240px; margin-top: 10px;">
	          <form id='payMoney' action='/gbdbas/alipay/playForm'>
	             ...
	             <span class='buttonSpan' onclick="payOrder()">付款</span>
		      </form>
	        </div>
           <div id='hasPay'></div>
      </div>
