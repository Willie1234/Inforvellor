...
<body>
	<div id="rightDiv"  style="display: none;width: 720px; height: 550px;padding:10px 20px;overflow-x:hidden;" >
	   <div style="font-size:5;font-weight:bold;  color:blue;">国家列表:</div>
	   <!-- 展示所有国家以及该用户拥有的国家权限 -->
	   <div id="countrysDiv" style="width:auto;height:150px;"></div>
	   <!-- 展示单个国家权限列表 -->
	   <div style="font-size:5; font-weight:bold; color:blue;margin-bottom: 6px; margin-top: 10px;">权限列表:</div>
	   ...
	   <div style="width:auto;height:30px;padding-left: 260px;">
	       <a class="confirmOrcancel_cls" title="授权" onclick="grantRight();">授权</a>&nbsp;&nbsp;
	       <a class="confirmOrcancel_cls" title="关闭" onclick="javascript:art.dialog({id:'rightDiv'}).close();">关闭</a>
	   </div>
