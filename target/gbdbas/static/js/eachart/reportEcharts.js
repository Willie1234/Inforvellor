...
function creatBodyHtml(id,title,subTitle,width,height,pageFlag){
	...
	if(pageFlag){
		...
		var pagingDiv=$("<div><span onclick=echartbigger('"+echartId+"') >" +
						"&nbsp;<img src='/gbdbas/static/js/eachart/img/big.png' title='放大' width='16px' /></span>" +
						"<span onclick=echartsmaller('"+echartId+"') >" +
						"<img src='/gbdbas/static/js/eachart/img/small.png' title='缩小' width='16px'/></span>" +
						"<span onclick=echartpreviousPage('"+echartId+"') >" +
						"<img src='/gbdbas/static/js/eachart/img/left.png' title='上一页' width='16px'/></span>" +
						"<span onclick=echartnextPage('"+echartId+"') >" +
						"<img src='/gbdbas/static/js/eachart/img/right.png' title='下一页' width='16px'/></span></div>");
		...
		pagingSize.text('页数：'+pageNow+'/'+pageTotal);
...
function echartnextPage(id){
	...
	pageIndex=pageIndex+showCount;
	pageNow+=1;
	$("#"+pagingSizeDiv).text('页数：'+pageNow+'/'+pageTotal);
	createMixEchart(id);
}
/**
 * 作用：上一页
