...
<div id="zzhao" style="background-color:white;">
		...
		<div style="position:absolute;float: left;margin-left:850px;margin-top: -60px;z-index:1000;">
	  	...
	  	<div id="head" style="background-color: #ffffff;top: 23px;margin:0 auto;align:left;padding: 0;width: 1210px;height:86px;position:absolute;">
		  	...
		  	<div style="float:right;padding-top:7px;padding-right:15px;">
				<a href="javascript:void(0)" style="font-family:微软雅黑;font-size:14px;color:#777F7F;" onmouseover="this.style.textDecoration='underline'" onMouseOut="this.style.textDecoration='none'" onclick="openUpdatePwdDlg()">修改密码</a>
		  	</div>
	 	</div>
	</div>
	<!--一级菜单栏 -->
	<div id="nav-strip">
          <ul>
               ...
               <li class="nav-item " id="nav-item_1"><a onclick="clickMenuForword(1);"><span class="primary-link"  id="font_color1">个人中心</span></a>
               		<div class="subnav" id="subnav_1">                       
	                     <div class="subnav-inner">
		                     <ul>
		                          <li class=""><a href="javascript:void(0)" onclick="clickMenuForword(2)">查看权限</a></li>
		                          <li class=""><a href="/gbdbas/view/personalcenter/myfavorites/myFavorites.jsp" onclick="clickMenuForword(3)">我的收藏</a></li>
		                          <li class=""><a href="/gbdbas/view/personalcenter/loginlog/userLoginLog.jsp" onclick="clickMenuForword(4)">登录日志</a></li>
		                          <li class=""><a href="javascript:void(0)" onclick="clickMenuForword(5)">子账号管理</a></li>   
		                    </ul>
	                    </div>
	               </div>
	           </li>
	           ...
	           <li class="menu_line"></li>
               <li class="nav-item no-subnav active" id="nav-item_2"><a onclick="clickMenuForword(6)" ><span class="primary-link" id="font_color6">贸易情报</span></a></li>
               <li class="menu_line"></li>
               <li class="nav-item no-subnav active" id="nav-item_3"><a onclick="clickMenuForword(7)" ><span class="primary-link">客户/对手</span></a>
               	  <div class="subnav" id="subnav_3">                       
	                     <div class="subnav-inner">
		                     <ul>
		                          <li class=""><a href="javascript:void(0)" onclick="clickMenuForword(7)">我的客户</a></li>
		                          <li class=""><a href="javascript:void(0)" onclick="clickMenuForword(8)">我的对手</a></li>
		                    </ul>
	                    </div>
	               </div>
               </li>
               <li class="menu_line"></li>
       	       <li class="nav-item" id="nav-item_4"><a href="javascript:void(0)" onclick="clickMenuForword(9)"><span class="primary-link" >产品标签</span></a></li> 
               <li class="menu_line"></li>
               <li class="nav-item no-subnav active" id="nav-item_5"><a onclick="clickMenuForword(10)" ><span class="primary-link">对比分析</span></a></li>
               <li class="menu_line"></li>
               <li class="nav-item no-subnav active" id="nav-item_6"><a onclick="clickMenuForword(11)" ><span class="primary-link">全库下载</span></a></li>
               <li class="menu_line"></li>
               ...
               <li class="nav-item no-subnav active" id="nav-item_8"><a onclick="clickMenuForword(13)" ><span class="primary-link">客服中心</span></a></li>
               <li class="menu_line"></li>
          </ul>
      </div>
